@include('layouts.partials.publisher.head')
    <!-- [ Sidebar Menu ] start -->
    @include('layouts.partials.publisher.nav')
    <!-- [ Sidebar Menu ] end -->
    <!-- [ Header Topbar ] start -->
    @include('layouts.partials.publisher.header')
    <!-- [ Header ] end -->
    ...
    @include('layouts.partials.publisher.footer')
