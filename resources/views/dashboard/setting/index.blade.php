                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('dashboard.setting.update') }}" method="POST"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="site_ar" name="site_ar"
                                        value="{{ old('site_ar', $settings['site_ar'] ?? '') }}" />
                                </div>

                                <div class="mb-4">
                                    <label class="form-label">{{ __('admin.Site_en') }}</label>
                                    <input type="text" class="form-control" placeholder="site_en" name="site_en"
                                        value="{{ old('site_en', $settings['site_en'] ?? '') }}" />
                                </div>
