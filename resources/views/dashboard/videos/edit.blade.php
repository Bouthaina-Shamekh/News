<x-dashboard-layout>
    ...
    <x-slot:breadcrumbs>
        ...
        @endcan
        <li class="breadcrumb-item" aria-current="page">{{ __('admin.Edit Video') }}</li>
    </x-slot:breadcrumb>

    <div class="col-span-12 xl:col-span-12">
        <div class="col-md-12">
            <div class="card">
                @can('edit', 'App\Models\Video')
                    <div class="card-header">
                        <h5>{{ __('admin.Edit Video') }}</h5>
                    </div>
                @endcan

                @can('edit', 'App\Models\Video')
                    <div class="card-body">
                        <form action="{{ route('dashboard.video.update', $videos->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
