                                ...
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('dashboard.category.destroy', $category->id) }}" method="post" class="w-8 h-8 rounded-xl inline-flex items-center justify-center btn-link-secondary delete-form">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="" title="{{ __('admin.Delete') }}">
