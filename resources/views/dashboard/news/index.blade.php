<x-dashboard-layout>
    ...
    <div class="col-span-12">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($new->img_view)
                                            @if (Storage::disk('public')->exists($new->img_view))
                                                <img src="{{ asset('storage/' . $new->img_view) }}" width="50"
                                                    alt="Image">
                                            @else
                                                {{ __('No Image') }}
                                            @endif
                                    ...
                                    <td>
                                        <a href="{{ route('site.new', $new->id) }}" target="_blank"
                                            class="title">{{ $new->$title != null && $new->$title != '' ? $new->$title : $new->title_org }}</a>
                                    </td>
                                    ...
                                    <td class="d-flex">
                                        <a href="{{ route('dashboard.nw.edit', $new->id) }}"
        ...
        @endcan
        <button type="button" id="deleteConfirmModalBtn" class="btn btn-primary" style="display: none;"
            data-pc-toggle="modal" data-pc-target="#deleteConfirmModal">
            Launch demo modal
        </button>
    </div>
    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-center gap-3">
                            <button type="button" class="btn btn-secondary"
                                data-pc-modal-dismiss="#deleteConfirmModal">إلغاء</button>
