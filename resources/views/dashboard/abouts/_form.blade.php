<div class="row">
                     ...
                     <div class="form-group col-6 mb-3">
                        ...
                        <div class="form-group col-6 mb-3">
                            <label for="objective_ar" class="form-label">{{__('admin.objective_ar')}}<span style="color: red">*</span></label>
                            <textarea name="objective_ar" id="mytextarea" rows="3" class="form-control" required>{{$abouts->objective_ar}}</textarea>
                        </div>


                        <div class="form-group col-6 mb-3">
                            <label for="objective_en" class="form-label">{{__('admin.objective_en')}}<span style="color: red">*</span></label>
                        ...
                        <div class="form-group col-6 mb-3">
                            <label for="mission_en" class="form-label">{{__('admin.mission_en')}}<span style="color: red">*</span></label>
                            <textarea name="mission_en" id="mytextarea" rows="3" class="form-control" required>{{$abouts->mission_en}}</textarea>
                        </div>

                        <div class="form-group col-6 mb-3">
                            <label for="vission_ar" class="form-label">{{__('admin.vission_ar')}}<span style="color: red">*</span></label>
                            <textarea name="vission_ar" id="mytextarea" rows="3" class="form-control" required>{{$abouts->vission_ar}}</textarea>
                        </div>

                        <div class="form-group col-6 mb-3">
                            <label for="vission_en" class="form-label">{{__('admin.vission_en')}}<span style="color: red">*</span></label>
